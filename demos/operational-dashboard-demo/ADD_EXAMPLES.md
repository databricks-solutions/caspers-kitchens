# Adding Examples to the Operational Dashboard Agent Bricks
...
## Supervisor Agent (`{CATALOG}-operational-supervisor`)
...
## Legal Complaints KA (`{CATALOG}-legal`)
...
## Regulatory Compliance KA (`{CATALOG}-regulatory`)
...
## Audit Reports KA (`{CATALOG}-audits`)
...
## Consultancy Reports KA (`{CATALOG}-consultancy`)
...
## Inspection Reports KA (`{CATALOG}-inspection-knowledge`)
