...
const PACKAGE: &'static str = "caspers.messages.v1";
fn full_name() -> ::prost::alloc::string::String { "caspers.messages.v1.CloudEvent.CloudEventAttributeValue".into() }fn type_url() -> ::prost::alloc::string::String { "/caspers.messages.v1.CloudEvent.CloudEventAttributeValue".into() }}
    /// -- CloudEvent Data (Bytes, Text, or Proto)
    #[allow(clippy::derive_partial_eq_without_eq)]
#[derive(Clone, PartialEq, ::prost::Oneof)]
    pub enum Data {
...
const PACKAGE: &'static str = "caspers.messages.v1";
fn full_name() -> ::prost::alloc::string::String { "caspers.messages.v1.CloudEvent".into() }fn type_url() -> ::prost::alloc::string::String { "/caspers.messages.v1.CloudEvent".into() }}
/// *
...
const PACKAGE: &'static str = "caspers.messages.v1";
fn full_name() -> ::prost::alloc::string::String { "caspers.messages.v1.CloudEventBatch".into() }fn type_url() -> ::prost::alloc::string::String { "/caspers.messages.v1.CloudEventBatch".into() }}
#[allow(clippy::derive_partial_eq_without_eq)]
#[derive(Clone, PartialEq, ::prost::Message)]
...
impl ::prost::Name for OrderStatus {
const NAME: &'static str = "OrderStatus";
const PACKAGE: &'static str = "caspers.messages.v1";
fn full_name() -> ::prost::alloc::string::String { "caspers.messages.v1.OrderStatus".into() }fn type_url() -> ::prost::alloc::string::String { "/caspers.messages.v1.OrderStatus".into() }}
...
const PACKAGE: &'static str = "caspers.messages.v1";
fn full_name() -> ::prost::alloc::string::String { "caspers.messages.v1.Order".into() }fn type_url() -> ::prost::alloc::string::String { "/caspers.messages.v1.Order".into() }}
...
const PACKAGE: &'static str = "caspers.messages.v1";
fn full_name() -> ::prost::alloc::string::String { "caspers.messages.v1.LineItem".into() }fn type_url() -> ::prost::alloc::string::String { "/caspers.messages.v1.LineItem".into() }}
